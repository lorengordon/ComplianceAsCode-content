###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_anssi_nt28_minimal
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_anssi_nt28_minimal --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_sap
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_sap --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_C2S
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_C2S --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_rht-ccp
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_rht-ccp --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_anssi_np_nt28_average
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_anssi_np_nt28_average --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

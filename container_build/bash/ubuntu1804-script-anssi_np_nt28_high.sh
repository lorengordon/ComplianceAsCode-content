###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_anssi_np_nt28_high
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_anssi_np_nt28_high --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

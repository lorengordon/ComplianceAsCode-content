###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_cui
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_cui --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

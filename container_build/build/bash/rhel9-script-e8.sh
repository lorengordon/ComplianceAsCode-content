###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_e8
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_e8 --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

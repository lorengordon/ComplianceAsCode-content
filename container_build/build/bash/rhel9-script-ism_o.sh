###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_ism_o
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_ism_o --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

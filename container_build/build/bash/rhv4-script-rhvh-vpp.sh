###############################################################################
#
# Bash remediation role for profile xccdf_org.ssgproject.content_profile_rhvh-vpp
...
# 	$ oscap xccdf generate fix --profile xccdf_org.ssgproject.content_profile_rhvh-vpp --template urn:xccdf:fix:script:sh xccdf-file.xml 
#

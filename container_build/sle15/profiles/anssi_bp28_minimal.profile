description: "This profile contains configurations that align to ANSSI-BP-028 v2.0\
    ...
    \ should be installed.\nThose whose presence can not be justified should be disabled,\
    \ removed or deleted.\nPerforming a minimal install is a good starting point,\
    \ but doesn't provide any assurance\nover any package installed later.\nManual\
    \ review is required to assess if the installed services are minimal."
extends: null
metadata:
    SMEs:
    - abergmann
...
definition_location: /home/oscap/content/products/sle15/profiles/anssi_bp28_minimal.profile
